...
#[test]
fn get_table_test() {
    let (table, count) = Day5::get_table(Day5::get_test_input().as_str());
...
fn do_step_simple_test() {
    let (mut table, _) = Day5::get_table(Day5::get_test_input().as_str());
...
fn get_top_of_table_test() {
    let (table, _) = Day5::get_table(Day5::get_test_input().as_str());
    assert_eq!(Day5::get_top_of_table(&table), "NDP")
}

#[test]
fn part_1_test() {
    assert_eq!(Day5::part_1(Day5::get_test_input().as_str()), "CMZ")
}

#[test]
fn part_2_test() {
    assert_eq!(Day5::part_2(Day5::get_test_input().as_str()), "MCD")
}